  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-blue-500 to-purple-600">
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md text-center">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">AI Writing Assistant</h1>
        <p className="text-gray-600 mb-8">Elevate your writing with the power of AI</p>
        ...
        <p className="mt-6 text-sm text-gray-500">
          New to AI Writing Assistant? Click 'Get Started' to create your account.
        </p>
      </div>
    </div>
  );
